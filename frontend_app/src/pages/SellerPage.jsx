            ...
            <div className="seller-page-container">
                ...
                <div className="seller-main-card">
                    <div className="seller-tabs">
                        ...
                        <button style={tabStyle(tab === 'sales')} onClick={() => setTab('sales')} disabled={isNewProfile}>Sales & Orders</button>
                    </div>
                    ...
                    {tab === 'sales' && !isNewProfile && (
                        <div className="seller-tab-content">
                            <h2>Incoming Orders</h2>
                            <p>Here, sellers will be able to view and manage orders received from buyers.</p>
                        </div>
                    )}
                </div>
            </div>
